# xray-install
Xray installation and configuration script for **`Ubuntu`** and **`Debian`** servers.

## Features
- Automatically install and configure [Xray-core](https://github.com/XTLS/Xray-core)
...
### Run Script
```bash
curl -L https://raw.githubusercontent.com/parvinsamin/xray/main/xray.sh | bash
```
